...
#
# Comment from hashcathelper maintainer (may 2022): Since MD4 as a legacy
# algorithm is phased out from real crypto libs like openssl for good
# reason, we need this code. Modified to satisfy PEP8.
import struct
